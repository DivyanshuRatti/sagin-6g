...
Artificial Intelligence is becoming an important part of future Space-Air-Ground Integrated Networks. This survey reviewed recent studies that use AI techniques such as deep reinforcement learning, federated learning, multi-agent learning, and Generative AI to improve resource allocation, communication, mobility management, and network performance. The literature shows that these methods can make SAGIN more efficient and adaptable for future 6G networks.

However, the review also found several challenges. Most proposed solutions have only been tested through simulations, while real-world deployment is still limited. In addition, security and privacy receive less attention than performance optimization. Based on these findings, future research should focus on developing integrated AI frameworks and validating them in practical environments. Overall, AI has strong potential to support reliable, scalable, and intelligent SAGIN for next-generation wireless communication.
